<template>
	<div id="buyer">
		...
		<div class="buyer-market">
			<el-row :gutter="20">
				<el-col :span="6" style="font-size: 22px;color: #333333;">
					苹果微商城信号
				</el-col>
			</el-row>
			<el-row :gutter="20" v-for="num in buyerNumber">
				<el-col :span="2">
				...
				<el-col :span="4" :offset="8">
					<el-button style="line-height: 20px;color: #00AEFC;border: 1px solid #00AEFC;"><img src="../../../../static/Buyersignal/icon_weidianjishoucang.png" />分享</el-button>
				</el-col>
				<el-col :span="4">
					<el-button type="primary" style="color: #ffffff;line-height: 20px;background:#F5B55B;border:none;" @click="open2">下架信号</el-button>
				</el-col>
			</el-row>
